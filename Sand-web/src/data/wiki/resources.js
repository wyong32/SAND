...
export const resources = [
  ...
  { id: 4, title: 'Threads', guideLabel: 'THEARDS', group: 'Common Resources', type: 'Crafting / Trade / Research', use: 'Thread material for crafting, trading, and research tree progress.', source: 'Specialized boxes.', fieldNote: 'Some early references spell this as THEARDS; this page normalizes it to Threads for readability.' },
  ...
  { id: 12, title: 'Weird Coral', guideLabel: 'WEIRO CORAL', group: 'Uncommon Resources', type: 'Organic Material', use: 'Used in crafting or research tree progress.', source: 'Infected enemies.', fieldNote: 'Some early references spell this as WEIRO CORAL; this page uses Weird Coral for readability.' },
  ...
  { id: 28, title: 'Crystal', guideLabel: 'CRISTAL', group: 'Noteworthy Resources', type: 'Trade Item', use: 'Used for trade.', source: 'Crafted at a workbench from Raw Aurogen Crystal at a 1 to 4 ratio.', fieldNote: 'Some early references spell this as CRISTAL; this page normalizes it to Crystal.' },
